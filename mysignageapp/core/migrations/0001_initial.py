# Generated by Django 5.1 on 2024-08-17 15:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('Owner', 'Owner'), ('Designer', 'Designer'), ('Admin', 'Admin')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='contract', to='core.job')),
            ],
        ),
        migrations.CreateModel(
            name='Task',
